...
function searchFunction(event) {
    ...
    .then(function(data) {
       ...
       // icon1.textContent = data.weather[0].icon;
      ...
      //  const icon2 = document.querySelector("icon1");
       ...
       // date2.textContent = forecast[0].dt_txt
        //icon2.textContent = forecast[0].weather[0].icon;
       ...
       // const icon3 = document.querySelector("icon1");
      ...
      //  icon3.textContent = data.weather[0].icon;
       ...
       // const icon4 = document.querySelector("icon1");
      ...
      //  icon4.textContent = forecast[0].weather[0].icon;
      ...
      //  const icon5 = document.querySelector("icon1");
      ...
      //  icon5.textContent = data.weather[0].icon;
